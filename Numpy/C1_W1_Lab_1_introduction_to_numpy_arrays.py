...
lin_spaced_arr_int = np.linspace(0, 100, 13, dtype=int)
...
char_arr = np.array((['Welcome to Math for ML!','I love you'],[3,2]))
print(char_arr)
...
two_dim_arr = np.array([[1,2,3], ['sai',5,6]])
print(two_dim_arr)
...
multi_dim_arr = np.reshape(
               ...
               (3,2) # dimensions of the new array
              )
...
sliced_two_dim_cols = two_dim[:2,1]
...
np.hsplit(horz_stack,2)


# In[85]:


np.vsplit(horz_stack,2)
